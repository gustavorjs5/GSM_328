...
const unsigned char RESP_CONEXION      [] PROGMEM = "CNTAOK";
...
const unsigned char RESP_OUT1_OFF      [] PROGMEM = "S1OFOK";
const unsigned char RESP_OUT2_OFF      [] PROGMEM = "S2OFOK";
const unsigned char RESP_OUT3_OFF      [] PROGMEM = "S3OFOK";
const unsigned char RESP_OUTS_ON       [] PROGMEM = "STONOK";
const unsigned char RESP_OUTS_OFF      [] PROGMEM = "STOFOK";
